// Maan lo 'row' tumhare CSV ka ek item hai
if (row.ItemName == "" || row.ItemName == undefined) {
    return; // Ya loop mein 'continue' use karo, taaki khali row skip ho jaye
}
// Iske baad tumhara card banane wala code aayega...// Live Search Logic
